// © Виноградов Сергей Васильевич, 2007-2013
...
function _Collapsible()
{
    ...
    function trg_onClick()
    {
        ...
        else
        {
			...
			if (window.scrollTo && this._TgtPtr.y)
				window.scrollTo(0, this._TgtPtr.y)
			else
			if (window.scrollBy && this._TgtPtr.getClientRects)
				window.scrollBy(0, this._TgtPtr.getClientRects()[0].top - 20)
